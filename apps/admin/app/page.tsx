      ...
      <main className="main">
        <header className="top">
          <div>
            ...
            <h1 className="title">Good morning, operations.</h1>
          </div>
          <div className="live">
            <span className="dot" />
        ...
        <section className="metrics" aria-label="Beta metrics">
          <div className="metric">
            <Users size={19} />
            <strong>30</strong>
            <span>Qualified couples target</span>
          </div>
          <div className="metric">
            <BadgeCheck size={19} />
            <strong>17/25</strong>
            <span>Verified vendor target</span>
          </div>
          <div className="metric">
            <BookOpenCheck size={19} />
            <strong>6/10</strong>
            <span>Paid booking target</span>
          </div>
          <div className="metric">
            <CircleDollarSign size={19} />
            <strong>100%</strong>
            <span>Funds reconciled</span>
          </div>
        </section>
        <div className="grid">
          <section className="panel">
            ...
            {requests.map(([name, detail, state]) => (
