...
export default function OperationsDashboard() {
  return <div className="shell"><aside className="sidebar"><div className="brand">mmemme <small style={{fontSize:11,opacity:.65}}>OPS</small></div><nav className="nav" aria-label="Operations navigation">
    <a className="active" href="#"><LayoutDashboard size={17}/> Dashboard</a><a href="#"><BookOpenCheck size={17}/> Booking requests</a><a href="#"><Store size={17}/> Vendors</a><a href="#"><ShieldCheck size={17}/> Verification</a><a href="#"><CircleDollarSign size={17}/> Money & ledger</a><a href="#"><MessageSquareText size={17}/> Support</a>
